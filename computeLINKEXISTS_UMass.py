...
# P_comment : below function commented to test q_learning. Function with same name in STB_help.py used
...
# This function is independent of tau. Below two lines are not required only for q_learning.
...
createLinkExistenceADJ() # P_comment : Use the function in STB_help.py
